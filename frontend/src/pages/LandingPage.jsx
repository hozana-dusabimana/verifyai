    ...
    <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        <div className="mx-auto max-w-4xl glass p-12 rounded-3xl relative z-10">
          ...
          <div className="mt-10 max-w-xl mx-auto flex sm:flex-row flex-col gap-4">
            ...
            <button className="flex-none px-6 py-4 border border-transparent text-base font-medium rounded-xl text-white bg-brand-600 hover:bg-brand-700 shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 group">
              {t('landing.hero.analyzeNow')} <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </button>
          </div>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-8 border-t border-slate-200/60 pt-8">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-slate-500">{t('landing.stats.articlesAnalyzed')}</span>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-slate-500">{t('landing.stats.detectionAccuracy')}</span>
            </div>
            <div className="w-px h-12 bg-slate-200/60 hidden sm:block" />
            <div className="flex flex-col items-center">
              <span className="text-3xl font-bold text-slate-800 flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-slate-500">{t('landing.stats.avgAnalysisTime')}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white/50" id="how-it-works">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-base font-bold text-brand-600 tracking-wide uppercase">{t('landing.howItWorks.eyebrow')}</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              {
                step: "01",
                title: t('landing.howItWorks.steps.submit.title'),
                desc: t('landing.howItWorks.steps.submit.desc'),
                color: "bg-blue-100 text-blue-600"
              },
              {
                step: "02",
                title: t('landing.howItWorks.steps.analyze.title'),
                desc: t('landing.howItWorks.steps.analyze.desc'),
                color: "bg-brand-100 text-brand-600"
              },
              {
                step: "03",
                title: t('landing.howItWorks.steps.review.title'),
                desc: t('landing.howItWorks.steps.review.desc'),
      ...
      <section className="py-24">
         <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: t('landing.useCases.journalists.title'), icon: <Users className="w-8 h-8"/>, desc: t('landing.useCases.journalists.desc') },
                { title: t('landing.useCases.governments.title'), icon: <Building className="w-8 h-8"/>, desc: t('landing.useCases.governments.desc') },
                { title: t('landing.useCases.citizens.title'), icon: <ShieldAlert className="w-8 h-8"/>, desc: t('landing.useCases.citizens.desc') }
              ].map((c, idx) => (
      ...
      <section className="py-24 bg-slate-900 text-white rounded-[3rem] mx-4 mb-8" id="pricing">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <h2 className="text-base font-bold text-brand-400 tracking-wide uppercase">{t('landing.pricing.eyebrow')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto text-left">
              {[
                { name: t('landing.pricing.tiers.citizen.name'), price: t('landing.pricing.tiers.citizen.price'), desc: t('landing.pricing.tiers.citizen.desc'), limits: t('landing.pricing.tiers.citizen.limits') },
                { name: t('landing.pricing.tiers.pro.name'), price: t('landing.pricing.tiers.pro.price'), desc: t('landing.pricing.tiers.pro.desc'), limits: t('landing.pricing.tiers.pro.limits'), popular: true },
                { name: t('landing.pricing.tiers.enterprise.name'), price: t('landing.pricing.tiers.enterprise.price'), desc: t('landing.pricing.tiers.enterprise.desc'), limits: t('landing.pricing.tiers.enterprise.limits') }
              ].map((tier, idx) => (
                <div key={idx} className={`relative p-8 rounded-3xl border ${tier.popular ? 'border-brand-500 bg-slate-800' : 'border-slate-700 bg-slate-800/50'}`}>
                  {tier.popular && <div className="absolute top-0 right-6 translate-y-[-50%] bg-brand-500 text-white px-3 py-1 rounded-full text-xs font-bold font-tracking-wide uppercase">{t('landing.pricing.mostPopular')}</div>}
                  ...
                  <ul className="mb-8 space-y-4 text-slate-300">
                    ...
                    <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-brand-400"/> {t('landing.pricing.features.ensemble')}</li>
                    <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-brand-400"/> {t('landing.pricing.features.explainability')}</li>
                  </ul>
      ...
      <section className="py-24 bg-brand-50" id="about">
         <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
            <h2 className="text-base font-bold text-brand-600 tracking-wide uppercase">{t('landing.about.eyebrow')}</h2>
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-slate-900 sm:text-4xl">
      ...
      <section className="py-24 bg-white" id="contact">
         <div className="mx-auto max-w-4xl px-6 lg:px-8 text-center">
            <h2 className="text-base font-bold text-brand-600 tracking-wide uppercase">{t('landing.contact.eyebrow')}</h2>
            ...
            <div className="glass p-10 rounded-3xl text-left border border-slate-200 shadow-sm max-w-xl mx-auto">
               <form className="space-y-4">
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">{t('landing.contact.nameLabel')}</label>
                    <input type="text" className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-500 bg-slate-50" placeholder={t('landing.contact.namePlaceholder')} />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">{t('landing.contact.emailLabel')}</label>
                    <input type="email" className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-500 bg-slate-50" placeholder={t('landing.contact.emailPlaceholder')} />
                  </div>
                  <div>
                    <label className="block text-sm font-bold text-slate-700 mb-1">{t('landing.contact.messageLabel')}</label>
                    <textarea className="w-full h-32 px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-brand-500 bg-slate-50 resize-none" placeholder={t('landing.contact.messagePlaceholder')}></textarea>
                  </div>
      ...
      <footer className="mt-auto border-t border-slate-200 py-12 px-6">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm text-slate-500 font-medium">
            ...
            <a href="#" className="hover:text-brand-600">{t('landing.footer.documentation')}</a>
            <a href="#" className="hover:text-brand-600">{t('landing.footer.contact')}</a>
          ...
          <p className="text-sm text-slate-400">{t('landing.footer.rights', { year: new Date().getFullYear() })}</p>
        </div>
      </footer>
    </div>
  );
