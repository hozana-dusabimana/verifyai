"""
Django settings for VerifyAI backend.
"""
...
# Database — MySQL in prod (XAMPP locally), SQLite for CI/tests.
...
# charset is a MySQL-only connection option; SQLite's connect() rejects it.
...
CELERY_TIMEZONE = 'UTC'
# Run tasks synchronously in dev (no Redis required)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@verifyai.com')
...
GOOGLE_OAUTH2_REDIRECT_URI = os.getenv('GOOGLE_OAUTH2_REDIRECT_URI', 'http://localhost:8000/api/v1/auth/oauth/google/callback')
