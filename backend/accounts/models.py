...
class User(AbstractUser):
    ...
    def has_role_permission(self, permission):
        ...
        permissions_map = {
            ...
            'analytics_dashboard': [self.Role.JOURNALIST, self.Role.GOVERNMENT, self.Role.CITIZEN, self.Role.ADMIN],
            'export_reports': [self.Role.JOURNALIST, self.Role.GOVERNMENT, self.Role.CITIZEN, self.Role.ADMIN],
            'manage_alerts': [self.Role.JOURNALIST, self.Role.GOVERNMENT, self.Role.CITIZEN, self.Role.ADMIN],
